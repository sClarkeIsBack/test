...
tmpini       =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.MediaHubIPTV/resources/ivue','tmp.ini'))

def iVueInt():

	xbmc.executebuiltin("ActivateWindow(busydialog)")
	Clean_Names_MYADDONID(ini,tmpini)
	...
	FullDB = os.path.join(iVueFold, 'fullivue.zip')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("MediaHubIPTV","Installing...",'', 'Please Wait')
